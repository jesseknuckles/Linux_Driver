...
void* mqueuei; //contains addy where next message will be added to queue
void* mqueueo; //contains addy where next message will be read from queue
char* start; //will always contain the start addy of queue.
